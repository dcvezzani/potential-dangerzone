...
when resources are required as jars that you won't need to use "import".  _These
aren't needed for this example, but I thought I would include my findings._
